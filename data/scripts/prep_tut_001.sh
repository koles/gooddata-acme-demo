...
csvjoin -c customer_id $DATA_DIR/orders.csv $DATA_DIR/customers.csv > $TEMP_DIR/temp1.csv
...
csvcut -c 1-12,14,17,18 $TEMP_DIR/temp4.csv > $DATA_DIR/orders_tut_001.sh
